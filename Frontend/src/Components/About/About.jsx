          ...
          <ul>
            <div className="flex gap-3 py-4">
              ...
              <span className="w-96">
                ...
                I have expertise in HTML, CSS, JavaScript, React.js, Bootstrap, and Tailwind CSS. Skilled in creating responsive and interactive user interfaces with clean and efficient code, I strive to deliver seamless user experiences while ensuring optimal performance."
                </p>
              </span>
            </div>
            <div className="flex gap-3 py-4">
